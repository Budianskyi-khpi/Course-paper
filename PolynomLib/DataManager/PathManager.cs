...
namespace PolynomialLib.DataManager
{
    public static class PathManager
    {
        ...
        /// <summary>
        /// Method for creating file in specidied place
        /// </summary>
        /// <param name="fullPath">Full path with file name</param>
        /// <param name="autoCreate">Whether folders will be autogenerated if they don't exists</param>
        /// <returns>Path to where file was created</returns>
        ...
        /// <summary>
        /// Delete file on specidied place
        /// </summary>
        ...
        public static void Delete(string path)
        {
            ...
            {
                throw new Exception($"There is no such file! Given full path {path} wasn't found");
            }
            else
            {
                file.Delete();
